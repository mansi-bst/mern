      ...
      >
        ...
        <section className="px-6 pb-16 pt-20 text-center">
          <div className="mx-auto max-w-3xl">
            <span
              className={`inline-block rounded-full border px-4 py-4 mt-5 text-sm font-medium ${
                darkMode
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`group rounded-2xl border p-7 transition-all duration-300 hover:-translate-y-2 hover:border-blue-500/60 ${
                    darkMode
        ...
        {/* Bottom CTA */}
        <section
          className={`border-t px-6 py-20 transition-colors duration-300 ${
            darkMode ? "border-slate-800" : "border-slate-200"
          }`}
        >
          <div
            className={`mx-auto max-w-4xl rounded-2xl border p-10 text-center sm:p-14 ${
              darkMode
          ...
          >
            ...
            <button
              ...
              className="mt-8 cursor-pointer rounded-lg bg-blue-600 px-7 py-3 font-semibold text-white transition-all duration-200 hover:scale-105 hover:bg-blue-500"
            >
              Get Started
            </button>
          </div>
